...
const newWordsRaw = [
  { "jp": "め", "romaji": "me", "vi": "Con mắt" },
  { "jp": "きれいな", "romaji": "kireina", "vi": "Đẹp, sạch sẽ" },
  { "jp": "よる", "romaji": "yoru", "vi": "Buổi tối, ban đêm" },
  { "jp": "せんす", "romaji": "sensu", "vi": "Cái quạt xếp" },
  { "jp": "かに", "romaji": "kani", "vi": "Con cua" },
  { "jp": "つの", "romaji": "tsuno", "vi": "Sừng" },
  { "jp": "へい", "romaji": "hei", "vi": "Bức tường, hàng rào" },
  { "jp": "くつ", "romaji": "kutsu", "vi": "Giày" },
  { "jp": "あし", "romaji": "ashi", "vi": "Chân" },
  { "jp": "ここ", "romaji": "koko", "vi": "Ở đây, chỗ này" },
  { "jp": "くし", "romaji": "kushi", "vi": "Cái lược" }
];

async function appendHiragana() {
  try {
    const FOLDER_NAME = 'Hiragana';
    ...
    if (wordsToAdd.length === 0) {
      console.log('Tất cả 11 từ đã tồn tại, không cần thêm.');
      return;
    }
    ...
    console.error('Lỗi thêm từ Hiragana:', err);
  }
}
